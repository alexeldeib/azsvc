...
func (in *AgentPoolSpec) DeepCopyInto(out *AgentPoolSpec) {
	*out = *in
	in.AgentPoolTemplate.DeepCopyInto(&out.AgentPoolTemplate)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgentPoolTemplate) DeepCopyInto(out *AgentPoolTemplate) {
	*out = *in
	if in.Version != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgentPoolTemplate.
func (in *AgentPoolTemplate) DeepCopy() *AgentPoolTemplate {
	if in == nil {
		return nil
	}
	out := new(AgentPoolTemplate)
	in.DeepCopyInto(out)
	return out
}
